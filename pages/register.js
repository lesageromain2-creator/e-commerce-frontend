// frontend/pages/register.js - Style hôtel luxe
...
export default function Register() {
  ...
  return (
    <>
      <Head>
        <title>Inscription - {settings.site_name || DEFAULT_HOTEL.name}</title>
        <meta name="description" content={`Créez votre compte client ${settings.site_name || DEFAULT_HOTEL.name}`} />
        ...
        <div className={`register-container ${mounted ? 'mounted' : ''}`}>
          <div className={`register-card ${shake ? 'shake' : ''}`}>
            ...
            <div className="card-header">
              <p className="header-tagline">{settings.site_name || DEFAULT_HOTEL.name}</p>
              ...
              <h1 className="font-heading">Créer un compte</h1>
              <p>Rejoignez-nous pour gérer vos réservations et profiter de nos services</p>
            </div>
              ...
              <button
                ...
                onClick={async () => {
                  try {
                    ...
                    setErrors([err?.message || 'Erreur inscription Google']);
                    triggerShake();
                  }
                }}
              >
          ...
          {/* Benefits Side Panel - Hôtel luxe */}
          <div className="benefits-panel">
            <div className="benefits-content">
              ...
              <h2 className="font-heading">Vos avantages</h2>
              <p className="benefits-intro">{DEFAULT_HOTEL.tagline}</p>
      ...
      <style jsx>{`
        * {
        ...
        .orb-2 {
          width: 350px;
          height: 350px;
          background: radial-gradient(circle, rgba(107,44,62,0.12) 0%, transparent 70%);
          bottom: -100px;
          right: -100px;
          animation-delay: 7s;
        }
        ...
        .submit-btn:hover:not(:disabled) {
          ...
          background: linear-gradient(135deg, #D4BC8E, #C9A96E);
        }
        ...
        .benefits-panel {
          background: linear-gradient(160deg, #1A1A1A 0%, #252525 50%, rgba(107,44,62,0.12) 100%);
          border: 1px solid rgba(201, 169, 110, 0.2);
          border-radius: 24px;
          padding: 2.5rem;
          color: #FAFAF8;
        ...
        .benefits-panel::before {
          ...
          position: absolute;
          inset: 0;
          background: radial-gradient(circle at 20% 80%, rgba(201,169,110,0.06) 0%, transparent 50%);
        }
